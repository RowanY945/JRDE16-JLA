...
def lambda_handler(event, context):
    ...
    try:
        ...
        cookies1.set('li_at', 'AQEDAVyKu8wB_TcWAAABl-3POjYAAAGYEdu-NlYAe1UalbTlcVY-Nh4hTgEe6gg0dvwX6uorJhBd-gFuXjJXCn8Vk8_VC0hA-qOi2Du4m5gy1NL3yhTJ-vQ1ognOZns1rCF5V31eNxTJa6oh3m8uPKvy', domain='www.linkedin.com')
        cookies1.set('JSESSIONID', 'ajax:4989259530814177005', domain='www.linkedin.com')

# Authenticate using the cookies
# Make sure to pass an empty password when using cookies
        api1= Linkedin(cookies=cookies1,username='yg515401@gmail.com', password='')
        ...
        cookies2.set('li_at', 'AQEDAVyzKGIDHUSwAAABmANqfu8AAAGYJ3cC71YAyHTuXXJba-x9qyUe-x0nnTRFLnLoIrzSOz1I8obTnjHPaiuCRMousnKXhZdbRAwSV_iXDgiZNobPRq9ZF6iHHQfsV_bZw1RPd4GoDEHieiJq88KQ', domain='www.linkedin.com')
        cookies2.set('JSESSIONID', 'ajax:4381353554233707858', domain='www.linkedin.com')
        api2= Linkedin(cookies=cookies2,username='brucezhong02@outlook.com', password='')
# Authenticate using the cookies
# Make sure to pass an empty password when using cookies
